...
public class WikipediaSearcher {
    ...
    public String getPageRevisions(String title, int limit) {
        ...
        try {
            ...
            String query = "action=query" + "&format=json"+"&formatversion=2"+"&prop=revisions"+"&titles=" +
                    URLEncoder.encode(title, Charset.defaultCharset()) + "&rvprop=timestamp|user"+"&rvlimit=" +
                    limit + "&redirects=1";
